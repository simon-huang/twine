...
var repoDir = 'testRepos/6MergeConflict/6MergeTestOriginal';
var secondRepoDir = 'testRepos/6MergeConflict/6MergeTestClone';
var repository;
var index;
...
return fse.remove(path.resolve(__dirname, 'testRepos/6MergeConflict'))
// CREATE ORIGIN
.then(function() {
...
.then(function(a) {
  ...
  return exec("git --git-dir=/Users/simonhuang/Desktop/publishus/spec/git/testRepos/6MergeConflict/6MergeTestOriginal/.git --work-tree=/Users/simonhuang/Desktop/publishus/spec/git/testRepos/6MergeConflict/6MergeTestOriginal/ pull me master");
})
.then(function(a,b,c) {
  console.log('pushed ', a,b,c);
})
.catch(function(a,b,c) {
  console.log('push conflict ', a,b,c);
})
.done(function() {
  console.log("Done!");
});
